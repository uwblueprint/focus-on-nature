        ...
        <HStack>
          <VStack align="start" flexGrow="1">
            <FormControl isRequired isInvalid={!formStateVariables.firstName}>
              ...
              <Input 
                onChange={(event) => {setStateFuncs.setFirstName(event.target.value)}}
          ...
          <VStack align="start" flexGrow="1">
            <FormControl isRequired isInvalid={!formStateVariables.lastName}>
              ...
              <Input 
                onChange={(event) => {setStateFuncs.setLastName(event.target.value)}}
          ...
          <VStack align="start" flexGrow="1">
            <FormControl isRequired isInvalid={!formStateVariables.age}> 
              ...
              <Input 
                onChange={(event) => {setStateFuncs.setAge(parseInt(event.target.value, 10))}}
        ...
        <VStack align="start">
          <FormControl> 
            ...
            <Textarea 
              ...
              textAlign="start"
              resize="none"
              onChange={(event) => {setStateFuncs.setAllergies(event.target.value)}}
          ...
          <FormControl>
            ...
            <Textarea 
              ...
              minH="120px"
              textAlign="start"
              onChange={(event) => {setStateFuncs.setSpecialNeeds(event.target.value)}}
