...
const SelectModal = ({
  ...
  const addCamperToBeMoved = (newCamper: Camper) => {
    setCampersToBeMoved(
      (prevCampersToBeMoved) => new Set(prevCampersToBeMoved.add(newCamper)),
    );
  };
  ...
  return (
    <SelectCampersModal
      ...
      campersToBeSelected={campersToBeMoved}
      addCamperToBeSelected={addCamperToBeMoved}
      removeCamperToBeSeleted={removeCamperToBeMoved}
