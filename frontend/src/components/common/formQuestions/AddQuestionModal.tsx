...
import { CreateFormQuestion, QuestionCategory, QuestionType} from "../../../types/CampsTypes";
...
const QuestionOptionSection = ({
    ...
    const handleFormChange = (index : number, e: React.ChangeEvent<HTMLInputElement>) =>  {
        const data = [...options]
        ...
        <VStack minW="100%" key="options_stack">
            {
                options.map((option, index) => {
                    return (
                        <HStack key={`${option}_${index}_stack`} minW="100%" align="start" alignItems="center">
                            
                            { questionType === "MultipleChoice" &&
                                <Radio 
                                    size="lg" 
                                    key={`${option}_${index}_radio`}
                                    isReadOnly
                                />
                            }
            ...
            >
                ...
                >
                    <HStack>
                        <Button 
                            onClick={closeModal} 
                            variant="cancelGreenOutline"
                        >
                            Cancel
                        </Button>
                        <Button 
                            variant="saveGreenFilled"
